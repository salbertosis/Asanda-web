...
import FeaturedAthleteDirectory from '../components/FeaturedAthleteDirectory';

const AtletasDestacadosPage = () => (
  <div className="min-h-screen overflow-x-hidden bg-slate-50 dark:bg-slate-950">
    <header data-testid="featured-athletes-hero" className="relative isolate overflow-hidden bg-gradient-to-br from-asanda-deep via-slate-900 to-cyan-950 text-white">
      ...
      <div className="relative mx-auto flex max-w-7xl items-center gap-4 px-4 py-7 sm:px-6 sm:py-9 lg:px-8 lg:py-10">
        ...
        <div className="min-w-0 border-l-2 border-asanda-orange pl-4">
          ...
          <h1 className="mt-1 text-3xl font-black tracking-tight sm:text-4xl">Atletas destacados</h1>
          <p className="mt-1.5 max-w-2xl text-sm leading-5 text-slate-200 sm:text-base sm:leading-6">Atletas seleccionados por ASANDA para el reconocimiento público.</p>
        </div>
      </div>
    </header>
    <section className="py-6 md:py-8" aria-label="Directorio de atletas destacados">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <FeaturedAthleteDirectory />
      </div>
    </section>
  </div>
);

export default AtletasDestacadosPage;
