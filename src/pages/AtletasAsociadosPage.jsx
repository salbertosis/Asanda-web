...
const AtletasAsociadosPage = () => {
  ...
  // Obtener todos los clubes únicos de los atletas asociados
  const clubesConAsociados = useMemo(() => {
    const atletasAsociados = atletas.filter(a => a.tipo === 'asociado');
    const clubsUnicos = [...new Set(atletasAsociados.map(a => a.club))];
    return ['Todos', ...clubsUnicos.sort()];
  }, []);

  // Filtrar atletas asociados por club
  const atletasFiltrados = useMemo(() => {
    const asociados = atletas.filter(a => a.tipo === 'asociado');
    if (clubActivo === 'Todos') {
      return asociados.sort((a, b) => {
                  ...
                  {atletasFiltrados.length > 0 ? (
                    ...
                    <tr>
                      <td colSpan="4" className="px-6 py-12 text-center text-gray-500">
                        <p className="text-lg">No hay atletas asociados disponibles para este club.</p>
                      </td>
                    </tr>
                  )}
                </tbody>
